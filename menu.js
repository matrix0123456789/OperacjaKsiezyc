...
// druga czêœæ kodu 
function getData(zrodlo, id) { 
 if(ObiektXMLHttp) 
  {
   //var cell = document.getElementById(cel);
   if(id == 'wiado')
   ObiektXMLHttp.open("GET", zrodlo+'&nr='+nrwiad+'&czas='+ajaxakt);
   else
   ObiektXMLHttp.open("GET", zrodlo+'&czas='+ajaxakt);
...
ObiektXMLHttp.onreadystatechange = function() 
{
 if (ObiektXMLHttp.readyState == 4)
   ...
   // document.getElementById(cel).innerHTML = ObiektXMLHttp.responseText; 
	var tab = ObiektXMLHttp.responseText.split("|x/x|/x/x|");
	document.getElementById('kasa').innerHTML = tab[0];
	document.getElementById('graczy').innerHTML = tab[1];
	document.getElementById('graczytydzien').innerHTML = tab[2];
	document.getElementById('graczyonline').innerHTML = tab[3];
	ajaxakt = tab[4];
	if(id == 'temat')
	document.getElementById('nowytem').innerHTML = document.getElementById('nowytem').innerHTML + tab[5];
	if(id == 'wiado')
	{
		document.getElementById('wiado2').innerHTML = tab[6];
		document.getElementById('tabwiad').innerHTML = document.getElementById('tabwiad').innerHTML + tab[5];
	}
